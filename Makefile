...
# internal_pathogen_dynamics.o: ./custom_modules/internal_pathogen_dynamics.cpp
	# $(COMPILE_COMMAND) -c ./custom_modules/internal_pathogen_dynamics.cpp

external_immune.o: ./custom_modules/external_immune.cpp
	$(COMPILE_COMMAND) -c ./custom_modules/external_immune.cpp

# internal_pathogen_response.o: ./custom_modules/internal_pathogen_response.cpp
	# $(COMPILE_COMMAND) -c ./custom_modules/internal_pathogen_response.cpp
...
EasyBMP.o: ./custom_modules/EasyBMP.cpp ./custom_modules/EasyBMP*.h
	$(COMPILE_COMMAND) -c ./custom_modules/EasyBMP.cpp
